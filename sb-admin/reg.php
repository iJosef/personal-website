                            ...
                            <?php
                                ...
                                if (isset($_POST['username']) && isset($_POST['password']) && isset($_POST['submit'])) {
                                    ...
                                    if (!empty($un) && !empty($pw)) {
                                        if ($pw == $cpw) {
                                            $query = "INSERT INTO users (username, password) VALUES ('".mysqli_real_escape_string($db, $un)."', '$pass_hash')";
                                            $sql = mysqli_query($db, $query);

                                            if ($sql == TRUE) {
                                                echo '<p style="color:green;">Account Created Successfully. Proceed to <a href="index.php">Login</a>.</p>';
                                            }else{
                                                echo '<p style="color:red;">An Error Occured. Try Again.</p>';
                                            }
                                        }else{
