        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li class="active"><i class="icon-file-alt"></i> Comments</li>
            </ol>
                   ...
                   //determine the number of pages available
                    ...
                    $sql="SELECT comments.commentid, comments.visitor, comments.eMail, comments.comment, comments.commentDate, comments.commentTime, posts.posttitle, posts.postid, comments.approval FROM comments, posts WHERE comments.postid = posts.postid ORDER BY commentid DESC LIMIT " .$this_page_first_result.','.$results_per_page;  
                      ...
                      if (isset($_GET['approval'])) {
                        ...
                        switch ($filter) {
                          case 'approved':
                            $sql="SELECT comments.commentid, comments.visitor, comments.eMail, comments.comment, comments.commentDate, comments.commentTime, posts.posttitle, posts.postid, comments.approval FROM comments, posts WHERE comments.postid = posts.postid AND comments.approval =1 ORDER BY commentid DESC LIMIT " .$this_page_first_result.','.$results_per_page;
                            break;

                            case 'pending':
                            $sql="SELECT comments.commentid, comments.visitor, comments.eMail, comments.comment, comments.commentDate, comments.commentTime, posts.posttitle, posts.postid, comments.approval FROM comments, posts WHERE comments.postid = posts.postid AND comments.approval =0 ORDER BY commentid DESC LIMIT " .$this_page_first_result.','.$results_per_page;
                            break;
                    ...
                    if($r){
                      ...
                      while ($row = mysqli_fetch_array($r)) {
                        ...
                        echo '<td>'.$row['commentDate'].' | '.$row['commentTime'].'</td>';
                        echo '<td><a href="editpost.php?id='.$row['postid'].'">'.$row['posttitle'].'</a></td>';
                        echo '<td><a href="approve.php?id='.$row['commentid'].'" title="approve comment?">&nbsp;&nbsp;&nbsp;<span class="fa fa-check" style="color:green; text-align:center;"></span></a><br/><a href="deletecomment.php?id='.$row['commentid'].'" title="delete comment?">&nbsp;&nbsp;&nbsp;<span class="fa fa-trash-o" style="color:#f9341e; text-align:center;"></span></a></td>';
                        echo "</tr>";
                      }
                    }
                  ?>
