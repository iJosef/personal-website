        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li class="active"><i class="icon-file-alt"></i> All Portfolio</li>
            </ol>
            <p><a href="addportfolio.php" class="btn btn-default">Add New Item</a></p>
            <div class="col-lg-6">
              ...
              <table class="table table-hover table-striped tablesorter">
                ...
                <tbody>
                  <?php
                    ...
                    $result = mysqli_query($db, "SELECT * FROM portfolio");
                   ...
                   //determine the number of pages available
                    ...
                    if($r){
                      while ($row = mysqli_fetch_array($r)) {
                        ...
                        echo '<td align="center"><img src="../img/portfolio/'.$row['photo'].'" height=40 width=40/></td>';
                        echo '<td>'.$row['description'].'</td>';
                        echo '<td>'.$row['website'].'</td>';
                        echo '<td><a href="editportfolio.php?id='.$row['portfolioid'].'">&nbsp;&nbsp;&nbsp;<span class="fa fa-pencil" style="color:black; text-align:center;"></span></a><br/><a href="deleteportfolio.php?id='.$row['portfolioid'].'">&nbsp;&nbsp;&nbsp;<span class="fa fa-trash-o" style="color:#f9341e; text-align:center;"></span></a></td>';
                        echo "</tr>";
                      }
                    }
                  ?>
             ...
             // echo "<b>Page: </b>";
              ...
              for ($page=1; $page<=$num_of_pages; $page++) { 
                 //echo '<span><a href="research-papers.php?page='.$page.'" style="border:solid 1px;padding:5px;margin:5px;background-color:skyblue;color:white;"><b>'.$page.'   </b></a></span>';
                  ...
                  echo '<li><a href="portfolio.php?page='.$page.'">'.$page.'   </a></li>';
